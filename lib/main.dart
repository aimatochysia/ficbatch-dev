...
Future<void> main() async {
  ...
  // LAN sync: announce/listen on the local network (if enabled).
  final lanSync = LanSyncService(storage);
  try {
    await lanSync.start();
  } catch (e) {
    debugPrint('LAN sync initialization error: $e');
  }
  ...
  runApp(
    ProviderScope(
      overrides: [
        ...
        lanSyncProvider.overrideWithValue(lanSync),
      ],
